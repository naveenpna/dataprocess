...
def switch_demo(argument):
        switcher = {
            ...
            24:'ayfromsoftreset',
            25:'azfromsoftreset',
            26:'gxfromgyrodisable',
            27:'gyfromgyrodisable',
            28:'gzfromgyrodisable',
            29:'axfromgyrodisable',
            30:'ayfromgyrodisable',
            31:'azfromgyrodisable',
            32:'gxfromacceldisable',
            33:'gyfromacceldisable',
            34:'gzfromacceldisable',
            35:'axfromacceldisable',
            36:'ayfromacceldisable',
            37:'azfromacceldisable'
        }
...
def excel_modf(file1,summary_file,UL,LL,vdd):
    ...
    for z in range(1,datas.max_row+1,1):
        ...
        for i in range(1,13,1):
            ...
            mean1.append(np.nanmean(array))# calculate mean without zeroes. 
    avg1.append(mean1)
    avg2 = data.create_sheet('summary_table')
    
    
    # for inserting row and comlum titile 
    ...
    #36 = number of conditions (gyro+accel) from dictionary
...
#        print(avg)
    ...
    #fro writing the each condition in excel sheet
    #for i in range(0,ws.max_row,36):
